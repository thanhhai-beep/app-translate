...
export declare class ChaptersController {
    ...
    create(mangaId: string, createChapterDto: CreateChapterDto, file?: Express.Multer.File): Promise<import("./entities/chapter.entity").Chapter>;
    ...
    update(mangaId: string, id: string, updateChapterDto: UpdateChapterDto, file?: Express.Multer.File): Promise<import("./entities/chapter.entity").Chapter>;
