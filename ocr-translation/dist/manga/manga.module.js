...
exports.MangaModule = MangaModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([manga_entity_1.Manga, chapter_entity_1.Chapter])],
        controllers: [manga_controller_1.MangaController, chapter_controller_1.ChapterController],
        providers: [manga_service_1.MangaService, chapter_service_1.ChapterService],
        exports: [manga_service_1.MangaService, chapter_service_1.ChapterService],
    })
], MangaModule);
